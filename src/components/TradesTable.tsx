...
export const TradesTable: React.FC<TradesTableProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Controls & Filter Bar */}
      <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-4 backdrop-blur-sm space-y-3">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              placeholder="Rechercher par paire, setup, ticket, notes..."
              className="w-full rounded-xl border border-zinc-800 bg-zinc-950/80 pl-9 pr-4 py-2 text-xs text-white placeholder-zinc-400 focus:border-blue-500 focus:outline-none transition-all"
            />
          </div>
                ...
                <button
                  ...
                  className={`rounded-lg px-2.5 py-1 text-xs font-medium transition-all ${
                    active
                      ...
                      : 'border border-zinc-800 bg-zinc-950/50 text-zinc-400 hover:text-zinc-200'
                  }`}
                >
                  {p.label}
                </button>
        ...
        <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-zinc-800/60 text-xs">
          ...
          <select
            ...
            className="rounded-lg border border-zinc-800 bg-zinc-950 px-2.5 py-1.5 text-zinc-300 focus:border-blue-500 focus:outline-none"
          >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-zinc-800/40 text-xs text-zinc-400">
          <div className="flex items-center gap-4">
            <span>
              <strong className="text-white font-mono">{filteredTrades.length}</strong> trades trouvés
            </span>
            <span>
              Winrate filtré : <strong className="text-emerald-400 font-mono">{filteredWinrate.toFixed(1)}%</strong>
            </span>
            <span>
              Net P&L filtré : <strong className={`font-mono font-bold ${
          ...
          {selectedTradeIds.length > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-rose-600/20 border border-rose-500/40 px-2.5 py-1 text-rose-300 hover:bg-rose-600/30 transition-all"
            >
      ...
      {/* Trades Table */}
      <div className="overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-sm shadow-xl">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-zinc-300">
            {/* Header */}
            <thead className="border-b border-zinc-800 bg-zinc-950/70 font-mono text-[11px] uppercase tracking-wider text-zinc-400">
              <tr>
                ...
                <tr>
                  <td colSpan={11} className="py-12 text-center text-zinc-400">
                    <div className="flex flex-col items-center justify-center gap-2">
                      <Tag className="h-8 w-8 text-zinc-400 opacity-60" />
                ...
                filteredTrades.map((t) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Date & Time */}
                      <td className="p-3.5">
                        <div className="font-mono text-zinc-300">{t.entryDate}</div>
                      ...
                      <td className="p-3.5 pr-4 text-right" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1">
                          <button
                            onClick={() => onSelectTrade(t)}
                            className="p-1 text-zinc-400 hover:text-blue-400 rounded hover:bg-zinc-800 transition-all"
                          ...
                          <button
                            ...
                            className="p-1 text-zinc-400 hover:text-zinc-200 rounded hover:bg-zinc-800 transition-all"
                            title="Modifier"
                          >
                          ...
                          <button
                            ...
                            className="p-1 text-zinc-400 hover:text-rose-400 rounded hover:bg-zinc-800 transition-all"
                            title="Supprimer"
                          >
                            <Trash2 className="h-3.5 w-3.5" />
                          </button>
